...
module Database.Hbx.Proto.Crud.Order (Order(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Database.Hbx.Proto.Crud.Order.Direction as Database.Hbx.Proto.Crud.Order (Direction)
import qualified Database.Hbx.Proto.Expr.Expr as Database.Hbx.Proto.Expr (Expr)
 
data Order = Order{expr :: !(Database.Hbx.Proto.Expr.Expr), direction :: !(P'.Maybe Database.Hbx.Proto.Crud.Order.Direction)}
