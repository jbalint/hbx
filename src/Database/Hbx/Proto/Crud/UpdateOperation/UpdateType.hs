...
module Database.Hbx.Proto.Crud.UpdateOperation.UpdateType (UpdateType(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum UpdateType where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error "hprotoc generated code: toEnum failure for type Database.Hbx.Proto.Crud.UpdateOperation.UpdateType")
      . toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Database.Hbx.Proto.Crud.UpdateOperation.UpdateType"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Database.Hbx.Proto.Crud.UpdateOperation.UpdateType"
...
instance P'.ReflectEnum UpdateType where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".Mysqlx.Crud.UpdateOperation.UpdateType") [] ["Database", "Hbx", "Proto", "Crud", "UpdateOperation"]
        "UpdateType")
      ["Database", "Hbx", "Proto", "Crud", "UpdateOperation", "UpdateType.hs"]
