...
module Database.Hbx.Proto.Crud.Insert.TypedRow (TypedRow(..)) where
import Prelude ((+), (/))
...
data TypedRow = TypedRow{field :: !(P'.Seq Database.Hbx.Proto.Expr.Expr)}
...
instance P'.ReflectDescriptor TypedRow where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".Mysqlx.Crud.Insert.TypedRow\", haskellPrefix = [], parentModule = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Crud\",MName \"Insert\"], baseName = MName \"TypedRow\"}, descFilePath = [\"Database\",\"Hbx\",\"Proto\",\"Crud\",\"Insert\",\"TypedRow.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Mysqlx.Crud.Insert.TypedRow.field\", haskellPrefix' = [], parentModule' = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Crud\",MName \"Insert\",MName \"TypedRow\"], baseName' = FName \"field\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".Mysqlx.Expr.Expr\", haskellPrefix = [], parentModule = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Expr\"], baseName = MName \"Expr\"}), hsRawDefault = Nothing, hsDefault = Nothing}], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False}"
