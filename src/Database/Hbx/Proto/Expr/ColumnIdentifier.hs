...
module Database.Hbx.Proto.Expr.ColumnIdentifier (ColumnIdentifier(..)) where
import Prelude ((+), (/))
...
data ColumnIdentifier = ColumnIdentifier{document_path :: !(P'.Seq Database.Hbx.Proto.Expr.DocumentPathItem),
