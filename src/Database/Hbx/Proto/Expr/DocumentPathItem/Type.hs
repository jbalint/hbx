...
module Database.Hbx.Proto.Expr.DocumentPathItem.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Database.Hbx.Proto.Expr.DocumentPathItem.Type") .
      toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Database.Hbx.Proto.Expr.DocumentPathItem.Type"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Database.Hbx.Proto.Expr.DocumentPathItem.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".Mysqlx.Expr.DocumentPathItem.Type") [] ["Database", "Hbx", "Proto", "Expr", "DocumentPathItem"] "Type")
      ["Database", "Hbx", "Proto", "Expr", "DocumentPathItem", "Type.hs"]
