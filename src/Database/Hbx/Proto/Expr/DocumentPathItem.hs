...
module Database.Hbx.Proto.Expr.DocumentPathItem (DocumentPathItem(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Database.Hbx.Proto.Expr.DocumentPathItem.Type as Database.Hbx.Proto.Expr.DocumentPathItem (Type)
 
data DocumentPathItem = DocumentPathItem{type' :: !(Database.Hbx.Proto.Expr.DocumentPathItem.Type), value :: !(P'.Maybe P'.Utf8),
