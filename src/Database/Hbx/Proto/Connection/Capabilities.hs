...
module Database.Hbx.Proto.Connection.Capabilities (Capabilities(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Database.Hbx.Proto.Connection.Capability as Database.Hbx.Proto.Connection (Capability)
 
data Capabilities = Capabilities{capabilities :: !(P'.Seq Database.Hbx.Proto.Connection.Capability)}
...
instance P'.ReflectDescriptor Capabilities where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".Mysqlx.Connection.Capabilities\", haskellPrefix = [], parentModule = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Connection\"], baseName = MName \"Capabilities\"}, descFilePath = [\"Database\",\"Hbx\",\"Proto\",\"Connection\",\"Capabilities.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Mysqlx.Connection.Capabilities.capabilities\", haskellPrefix' = [], parentModule' = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Connection\",MName \"Capabilities\"], baseName' = FName \"capabilities\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = True, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".Mysqlx.Connection.Capability\", haskellPrefix = [], parentModule = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Connection\"], baseName = MName \"Capability\"}), hsRawDefault = Nothing, hsDefault = Nothing}], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False}"
