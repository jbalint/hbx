...
module Database.Hbx.Proto.Connection.CapabilitiesSet (CapabilitiesSet(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Database.Hbx.Proto.Connection.Capabilities as Database.Hbx.Proto.Connection (Capabilities)
 
data CapabilitiesSet = CapabilitiesSet{capabilities :: !(Database.Hbx.Proto.Connection.Capabilities)}
...
instance P'.ReflectDescriptor CapabilitiesSet where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".Mysqlx.Connection.CapabilitiesSet\", haskellPrefix = [], parentModule = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Connection\"], baseName = MName \"CapabilitiesSet\"}, descFilePath = [\"Database\",\"Hbx\",\"Proto\",\"Connection\",\"CapabilitiesSet.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".Mysqlx.Connection.CapabilitiesSet.capabilities\", haskellPrefix' = [], parentModule' = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Connection\",MName \"CapabilitiesSet\"], baseName' = FName \"capabilities\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = True, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".Mysqlx.Connection.Capabilities\", haskellPrefix = [], parentModule = [MName \"Database\",MName \"Hbx\",MName \"Proto\",MName \"Connection\"], baseName = MName \"Capabilities\"}), hsRawDefault = Nothing, hsDefault = Nothing}], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False}"
