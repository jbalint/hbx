...
module Database.Hbx.Proto.Expect.Open (Open(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Database.Hbx.Proto.Expect.Open.Condition as Database.Hbx.Proto.Expect.Open (Condition)
import qualified Database.Hbx.Proto.Expect.Open.CtxOperation as Database.Hbx.Proto.Expect.Open (CtxOperation)
 
data Open = Open{op :: !(P'.Maybe Database.Hbx.Proto.Expect.Open.CtxOperation),
                 cond :: !(P'.Seq Database.Hbx.Proto.Expect.Open.Condition)}
