...
module Database.Hbx.Proto.Expect.Open.Condition (Condition(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Database.Hbx.Proto.Expect.Open.Condition.ConditionOperation as Database.Hbx.Proto.Expect.Open.Condition
       (ConditionOperation)
 
data Condition = Condition{condition_key :: !(P'.Word32), condition_value :: !(P'.Maybe P'.ByteString),
                           op :: !(P'.Maybe Database.Hbx.Proto.Expect.Open.Condition.ConditionOperation)}
