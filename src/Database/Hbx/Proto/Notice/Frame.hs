...
module Database.Hbx.Proto.Notice.Frame (Frame(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Database.Hbx.Proto.Notice.Frame.Scope as Database.Hbx.Proto.Notice.Frame (Scope)
 
data Frame = Frame{type' :: !(P'.Word32), scope :: !(P'.Maybe Database.Hbx.Proto.Notice.Frame.Scope),
