...
module Database.Hbx.Proto.Notice.SessionStateChanged.Parameter (Parameter(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Parameter where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error "hprotoc generated code: toEnum failure for type Database.Hbx.Proto.Notice.SessionStateChanged.Parameter")
      . toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Database.Hbx.Proto.Notice.SessionStateChanged.Parameter"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Database.Hbx.Proto.Notice.SessionStateChanged.Parameter"
...
instance P'.ReflectEnum Parameter where
  reflectEnum
   = [(1, "CURRENT_SCHEMA", CURRENT_SCHEMA), (2, "ACCOUNT_EXPIRED", ACCOUNT_EXPIRED),
      ...
      (10, "PRODUCED_MESSAGE", PRODUCED_MESSAGE)]
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".Mysqlx.Notice.SessionStateChanged.Parameter") []
        ["Database", "Hbx", "Proto", "Notice", "SessionStateChanged"]
        "Parameter")
      ["Database", "Hbx", "Proto", "Notice", "SessionStateChanged", "Parameter.hs"]
      [(1, "CURRENT_SCHEMA"), (2, "ACCOUNT_EXPIRED"), (3, "GENERATED_INSERT_ID"), (4, "ROWS_AFFECTED"), (5, "ROWS_FOUND"),
       (6, "ROWS_MATCHED"), (7, "TRX_COMMITTED"), (9, "TRX_ROLLEDBACK"), (10, "PRODUCED_MESSAGE")]
