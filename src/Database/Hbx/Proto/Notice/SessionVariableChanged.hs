...
module Database.Hbx.Proto.Notice.SessionVariableChanged (SessionVariableChanged(..)) where
import Prelude ((+), (/))
...
data SessionVariableChanged = SessionVariableChanged{param :: !(P'.Utf8), value :: !(P'.Maybe Database.Hbx.Proto.Datatypes.Scalar)}
