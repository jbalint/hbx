...
module Database.Hbx.Proto.Datatypes.Object.ObjectField (ObjectField(..)) where
import Prelude ((+), (/))
...
data ObjectField = ObjectField{key :: !(P'.Utf8), value :: !(Database.Hbx.Proto.Datatypes.Any)}
