...
module Database.Hbx.Proto.ServerMessages.Type (Type(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Type where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Database.Hbx.Proto.ServerMessages.Type") .
      toMaybe'Enum
  succ OK = ERROR
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Database.Hbx.Proto.ServerMessages.Type"
  pred ERROR = OK
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Database.Hbx.Proto.ServerMessages.Type"
...
instance P'.ReflectEnum Type where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".Mysqlx.ServerMessages.Type") [] ["Database", "Hbx", "Proto", "ServerMessages"] "Type")
      ["Database", "Hbx", "Proto", "ServerMessages", "Type.hs"]
